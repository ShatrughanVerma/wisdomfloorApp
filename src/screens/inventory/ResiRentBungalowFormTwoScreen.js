...
// Villa forms so every screen in the app feels consistent across devices.
// ---------------------------------------------------------------------------
...
const BungalowFormScreen = ({ navigation }) => {
  ...
  const handleSubmit = () => {
    ...
    console.log('Bungalow form payload:', payload);
  };
...
export default BungalowFormScreen;
